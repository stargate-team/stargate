...
import tsinghua.stargate.annotation.InterfaceStability.Stable;
...
public interface ServiceStateChangeListener {
  ...
  /**
   * Callback to notify of a state change. The service will already have changed
   * state before this callback is invoked.
   *
   ...
   * <li>If another thread is somehow invoked from the listener, and that thread
   * invokes the methods of the service (including subclass-specific methods),
   * there is a risk of a deadlock.</li>
   * </ol>
   *
