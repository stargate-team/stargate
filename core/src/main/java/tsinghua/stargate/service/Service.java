...
public interface Service extends Closeable {
   ...
   * {@link STATE#STOPPED} state. It SHOULD be a best-effort attempt to stop all
  ...
  /**
   * Get the configuration of this service. This is normally not a clone and may
   * be manipulated, though there are no guarantees as to what the consequences
   ...
   * 
   * @return the start time of the service. This will be zero if the service has
   ...
   * executed (to success or failure), or the timeout elapsed This method can be
   * called before the service is inited or started; this is to eliminate any
   * race condition with the service stopping before this event occurs.
   * 
   ...
   */
  List<tsinghua.stargate.service.LifecycleEvent> getLifecycleHistory();
