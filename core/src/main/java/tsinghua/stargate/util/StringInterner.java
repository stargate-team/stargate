...
public class StringInterner {
  ...
  /**
   * Interns and returns a reference to the representative instance for any of a
   * collection of string instances that are equal to each other. Retains weak
   * reference to the instance, and so does not prevent it from being
   * garbage-collected.
   *
